...
public class Announcement implements FileOperations {
    ...
    public Announcement() {}
    public Announcement(String id, String title, String content, String date) { this.id=id; this.title=title; this.content=content; this.date=date; }
    @Override public String toFileString() { return id+"|"+title+"|"+content.replace("|",";")+"|"+date; }
