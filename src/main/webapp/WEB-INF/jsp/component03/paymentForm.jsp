...
<div class="container py-5 mt-4">
    <div class="mx-auto" style="max-width: 600px;">
        <a href="/payments" class="btn btn-link text-light text-decoration-none mb-3"><i class="bi bi-arrow-left"></i> Back to Payments</a>
            ...
            <form method="post" action="/payments/new">
                <div class="row g-3">
                    ...
                    <div class="col-12 d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-warning px-4 rounded-pill fw-bold">Record Payment</button>
