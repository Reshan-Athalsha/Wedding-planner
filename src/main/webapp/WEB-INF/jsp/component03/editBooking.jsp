            ...
            <form method="post" action="/bookings/edit">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="clientName" class="form-control bg-dark-transparent text-white border-secondary" value="${booking.clientName}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-white-50 small text-uppercase">Vendor Name</label>
                        <input type="text" name="vendorName" class="form-control bg-dark-transparent text-white border-secondary" value="${booking.vendorName}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-white-50 small text-uppercase">Event Date</label>
                        <input type="date" name="eventDate" class="form-control bg-dark-transparent text-white border-secondary" value="${booking.eventDate}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-white-50 small text-uppercase">Status</label>
                        <select name="status" class="form-select bg-dark-transparent text-white border-secondary">
                            <option value="PENDING" class="bg-dark" ${booking.status == 'PENDING' ? 'selected' : ''}>Pending</option>
                            <option value="CONFIRMED" class="bg-dark" ${booking.status == 'CONFIRMED' ? 'selected' : ''}>Confirmed</option>
                            <option value="CANCELLED" class="bg-dark" ${booking.status == 'CANCELLED' ? 'selected' : ''}>Cancelled</option>
                        </select>
                    </div>
