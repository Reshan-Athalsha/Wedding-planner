...
<!DOCTYPE html><html lang="en"><head>
  ...
  <title>Guest List — Tie The Tech</title>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}body{font-family:'Outfit',sans-serif;min-height:100vh;background:linear-gradient(135deg,#1a0533,#2d1b69,#0d2137);padding:32px 20px;color:#fff}
    ...
    .badge-attending{background:rgba(34,197,94,0.2);color:#86efac}.badge-declined{background:rgba(239,68,68,0.2);color:#fca5a5}.badge-pending{background:rgba(245,158,11,0.2);color:#fcd34d}
  ...
  <div class="card">
    ...
    <form method="post" action="/planning/guests/add">
      ...
      <div class="form-group"><label>RSVP</label>
        <select name="rsvpStatus" id="rsvpStatus"><option value="PENDING">Pending</option><option value="ATTENDING">Attending</option><option value="DECLINED">Declined</option></select>
      </div>
