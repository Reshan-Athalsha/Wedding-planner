...
<head>
    ...
    <title>Edit Review — Tie The Tech</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="container py-5">
    ...
    <div class="glass-card p-5 shadow">
        <div class="text-center mb-4">
            <span class="section-header-badge mb-2"><i class="bi bi-pencil-square me-1"></i> Modifying Feedback</span>
            <h2 class="fw-bold text-white mb-2">Edit Your Review</h2>
            <p class="text-white-50 small" style="max-width: 550px; margin: 0 auto;">You are modifying a verified review (`${review.reviewId}`). Your original review date (`${review.reviewDate}`) will be preserved.</p>
        </div>
        ...
        <form method="post" action="/reviews/edit" class="needs-validation" novalidate>
            ...
            <div class="row mb-4">
                <div class="col-md-6 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="reviewerName" name="reviewerName" class="form-control border-start-0 ps-0" value="${review.userName}" style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;" required>
                    </div>
                </div>
                <div class="col-md-6 form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="vendorName" name="vendorName" class="form-control border-start-0 ps-0" value="${review.vendorId}" style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6 form-group">
                    ...
                    <select id="rating" name="rating" class="form-select" required>
                        <option value="5" ${review.rating == 5 ? 'selected' : ''}>★★★★★ (5 Stars - Perfect!)</option>
                        <option value="4" ${review.rating == 4 ? 'selected' : ''}>★★★★☆ (4 Stars - Great Service)</option>
                        <option value="3" ${review.rating == 3 ? 'selected' : ''}>★★★☆☆ (3 Stars - Satisfactory)</option>
                        <option value="2" ${review.rating == 2 ? 'selected' : ''}>★★☆☆☆ (2 Stars - Needs Improvement)</option>
                        <option value="1" ${review.rating == 1 ? 'selected' : ''}>★☆☆☆☆ (1 Star - Poor Experience)</option>
                    </select>
                </div>
                <div class="col-md-6 form-group">
                    ...
                    <select id="reviewType" name="reviewType" class="form-select" required>
                        <!-- Verified is default when editing, as PublicReviews cannot be edited anyway -->
                        <option value="VERIFIED" ${review.reviewType == 'VERIFIED' ? 'selected' : ''}>Verified (Couples who booked through TTT - Editable)</option>
                        <option value="PUBLIC" ${review.reviewType == 'PUBLIC' ? 'selected' : ''}>Public Review (General feedback - Final/Cannot edit)</option>
                    </select>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-3 border-top border-secondary-subtle pt-4">
                ...
                <button type="submit" class="btn btn-premium-primary px-5 py-3"><i class="bi bi-check-circle me-2"></i>Save Changes</button>
            </div>
        </form>
    </div>
</div>
