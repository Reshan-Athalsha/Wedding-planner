...
<!DOCTYPE html><html lang="en"><head>
  ...
  <title>Submit Review — Tie The Tech</title>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .btn{padding:13px 28px;border:none;border-radius:12px;font-size:15px;font-weight:600;font-family:'Outfit',sans-serif;cursor:pointer;text-decoration:none;display:inline-block}
...
<div class="card">
  ...
  <form method="post" action="/reviews/submit">
    <div class="form-row">
      <div class="form-group"><label>Your Name</label><input type="text" name="reviewerName" placeholder="Your full name" required></div>
      <div class="form-group"><label>Vendor Name</label><input type="text" name="vendorName" placeholder="Vendor you are reviewing" required></div>
    </div>
    <div class="form-row">
      <div class="form-group"><label>Rating (1–5)</label>
        <select name="rating" required><option value="5">★★★★★ (5)</option><option value="4">★★★★☆ (4)</option><option value="3">★★★☆☆ (3)</option><option value="2">★★☆☆☆ (2)</option><option value="1">★☆☆☆☆ (1)</option></select>
      </div>
      <div class="form-group"><label>Review Type</label>
        <select name="reviewType" required><option value="VERIFIED">Verified (used service)</option><option value="PUBLIC">Public</option></select>
      </div>
    </div>
    <div class="form-group"><label>Your Review</label><textarea name="comment" placeholder="Share your experience..." required></textarea></div>
    <div class="actions"><button type="submit" class="btn btn-primary">Submit Review</button><a href="/reviews" class="btn btn-secondary">Cancel</a></div>
  </form>
</div></body></html>
