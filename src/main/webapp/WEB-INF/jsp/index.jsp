                ...
                <div id="heroCarousel" class="carousel slide carousel-fade shadow-lg" data-bs-ride="carousel" style="border-radius: 20px; overflow: hidden; border: 2px solid rgba(255,255,255,0.1);">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="4000">
                            <img src="https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80" class="d-block w-100" alt="Wedding planning" style="object-fit: cover; height: 350px;">
                        </div>
                        <div class="carousel-item" data-bs-interval="4000">
                            <img src="https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80" class="d-block w-100" alt="Wedding venue" style="object-fit: cover; height: 350px;">
                        </div>
                        <div class="carousel-item" data-bs-interval="4000">
                            <img src="https://images.unsplash.com/photo-1520854221256-17451cc7911a?w=800&q=80" class="d-block w-100" alt="Wedding celebration" style="object-fit: cover; height: 350px;">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="premium-card" >
                    ...
                    <div class="p-4">
                        ...
                        <a href="/vendors" class="btn btn-card text-white mt-3 w-100" style="background:linear-gradient(135deg,#f953c6,#b91d73)">Browse Vendors →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="premium-card" >
                    ...
                    <div class="p-4">
                        ...
                        <a href="/bookings" class="btn btn-card mt-3 w-100" style="background:linear-gradient(135deg,#f0c040,#d4a017);color:#1a1a2e">View Bookings →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="premium-card" >
                    ...
                    <div class="p-4">
                        ...
                        <a href="/planning" class="btn btn-card text-white mt-3 w-100" style="background:linear-gradient(135deg,#11998e,#38ef7d);color:#1a1a2e!important">Open Planner →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="premium-card" >
                    ...
                    <div class="p-4">
                        ...
                        <a href="/reviews" class="btn btn-card mt-3 w-100" style="background:linear-gradient(135deg,#f7971e,#ffd200);color:#1a1a2e">View Reviews →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="premium-card" >
                    ...
                    <div class="p-4">
                        ...
                        <a href="/admin" class="btn btn-card text-white mt-3 w-100" style="background:linear-gradient(135deg,#1a1a2e,#4776E6)">Admin Panel →</a>
                    </div>
                </div>
            </div>
